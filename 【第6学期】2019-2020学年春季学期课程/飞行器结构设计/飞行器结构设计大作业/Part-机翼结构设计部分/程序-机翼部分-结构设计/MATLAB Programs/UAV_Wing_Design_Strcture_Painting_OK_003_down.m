...
Cx(4)=0;
cr_2=cr-By_2;
cr_3=cr-By_3; % 3#加强肋的翼弦长度
Cy(1)=L_spar_1*cr;
Cy(2)=(L_spar_2*cr_3)+By_3;
Cy(3)=(L_spar_3*cr_3)+By_3;
Cy(4)=L_spar_4*cr;
...
Fx=linspace(Bx_2,Bx_2,n_stiff_vir);
Fy=linspace(((L_spar_1*cr_2)+By_2),((L_spar_4*cr_2)+By_2),n_stiff_vir);

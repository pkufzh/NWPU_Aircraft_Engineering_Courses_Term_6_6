...
disp('****************** ')
   ...
   choice2=input('   Please enter option frome above please: ');
   ...
   solvertype=1;
   if choice2==1;   
        [results,rudderangle]=fTrimAconst(geo,state,trimaxis,trimwing,trimrudder,solvertype);
        disp(' ') 
   elseif choice2==2;
        [results,rudderangle]=fTrimCLconst(geo,state,trimaxis,trimwing,trimrudder,solvertype);
        disp(' ')
   else

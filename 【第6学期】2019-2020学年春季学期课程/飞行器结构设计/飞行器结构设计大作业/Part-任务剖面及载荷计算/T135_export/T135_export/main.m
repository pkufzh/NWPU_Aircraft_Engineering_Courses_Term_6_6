   ...
   switch (answ)
      ...
      case 3
         ...
         if sum(sum(geo.flapped'))>0
              ...
              def=input('New control deflection [deg]: ')*pi/180;
     ...
     case 5
      ...
      case 6
         stat=1; %REMOVE THIS LINE BEFORE RELEASE
         if stat==1
...
disp('******************************************************');
disp('*                                                    *');
disp('*              Welcome to Tornado 135  (007)         *');
disp('*                                                    *');
disp('*                  by: Tomas Melin                   *');
disp('*                Copyright 1999-2010                 *');
disp('******************************************************');
%       
disp('*menues changed                                      *')
...
disp('*compressibility correction added.                   *')
disp('*                                                    *')
%

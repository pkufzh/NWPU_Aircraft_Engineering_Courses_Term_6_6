...
h_ct=plot([bh,bh],[(cr-ct),cr],'-g','LineWidth',1.8); % 机翼梢弦
h_rear=plot([0,bh],[cr,cr],'-g','LineWidth',1.8); % 机翼后缘
h_front=plot([0,bh],[0,(cr-ct)],'-g','LineWidth',1.8); % 机翼前缘
% h_cr=plot([0,0],[0,cr],'-','LineWidth',1.8,'Color',[0.64706 0.16471 0.16471]); % 机翼根弦
% h_ct=plot([bh,bh],[(cr-ct),cr],'-','LineWidth',1.8,'Color',[0.64706 0.16471 0.16471]); % 机翼梢弦
% h_rear=plot([0,bh],[cr,cr],'-','LineWidth',1.8,'Color',[0.64706 0.16471 0.16471]); % 机翼后缘
% h_front=plot([0,bh],[0,(cr-ct)],'-','LineWidth',1.8,'Color',[0.64706 0.16471 0.16471]); % 机翼前缘
